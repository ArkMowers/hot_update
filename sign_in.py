    ...
    def transition(self) -> bool:
        ...
        if self.find("connecting"):
            ...
            if self.tm.task == "back_to_index":
                ...
                if pos := self.find("@hot/ann5/entry"):
                    self.tap(pos)
                else:
            ...
            if self.tm.task == "orundum":
                if pos := self.find("@hot/orundum/button_start", score=0.6):
                    self.in_progress = True
                    self.tap(pos)
                elif self.find("@hot/orundum/button_complete"):
                    if self.in_progress:
                        self.sleep()
                    else:
                ...
                self.back()
        elif pos := self.find("@hot/headhunting/button"):
            if self.tm.task == "headhunting":
                if self.find("@hot/headhunting/banner"):
                    if self.find("@hot/headhunting/available"):
                        ...
                        self.back()
                elif self.find("@hot/headhunting/banner_exclusive"):
                    self.tap((1880, 590))
                else:
                ...
                self.back()
        elif self.find("@hot/headhunting/dialog"):
            if self.tm.task == "headhunting":
                self.tap((1263, 744))
            else:
                self.tap((663, 741))
            ...
            if self.tm.task == "headhunting":
                ...
                self.tm.complete("headhunting")
            self.tap((960, 540))
        elif self.find("@hot/ann5/banner"):
            if self.tm.task == "ann5":
                ...
                self.back()
        elif self.find("@hot/ann5/phono"):
            if self.tm.task == "ann5":
                self.notify("成功领取PhonoR-0小车")
            self.ctap((960, 540))
        elif self.find("@hot/ann5/savage"):
            if self.tm.task == "ann5":
